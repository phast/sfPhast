...
class pagesActions extends sfActions
{
	public function executeIndex(sfWebRequest $request)
	{
		...
		->setSave(function ($request, $response, Page $item) use ($user) {
			...
			if ($request['uri'] && ($item->isNew() || $item->getURI() != $request['uri'] || $item->getRoutePattern() != $request['route_pattern']) && PhastPagePeer::retrieveByRoute($request['uri'], $request['route_pattern'], $request['route_requirements']))
